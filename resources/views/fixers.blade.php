    ...
    <div class="mb-16">
        <div class="w-full px-10 pt-20">
            ...
            @elseif(session('id_repairman') != null)
                ...
                <p class="p-4 text-gray-700 text-justify mb-2">Žemiau pateikiamas visų remontininkų sąrašas. Naudotojai renkasi
            ...
            <div class="container mx-auto">
                ...
                @foreach($fixersData as $data)
                    <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-1/3 mx-2">
