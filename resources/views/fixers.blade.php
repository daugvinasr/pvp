            ...
            <div class="container mx-auto">
                <div role="list" class="flex items-center xl:justify-between flex-wrap justify-around">
                    @foreach($fixersData as $data)
                        <div role="listitem"
                             class="xl:w-3/4 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-1/3 mx-2">
                            <div class="rounded overflow-hidden shadow-md bg-white">
                                ...
                                text-white font-bold w-full text-center rounded" type="submit">Pasirinkti
                                            </button>
                                        </a>
                                    @endif
                                    <br>
