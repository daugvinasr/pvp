                    ...
                    <div class="bg-white">
                        ...
                        <div class="p-4">
                            <div class="flex items-center">
                                <h2 tabindex="0" class="focus:outline-none text-lg font-semibold">Įrenginys</h2>
                                <p tabindex="0" class="focus:outline-none text-xs text-gray-600 pl-5">prieš 4 dienas</p>
                            </div>
                            <p tabindex="0" class="focus:outline-none text-xs text-gray-600 mt-2">Aprašymas</p>
                            <div class="flex mt-4">
                                <div>
                                    <p tabindex="0" class="focus:outline-none text-xs text-gray-600 px-2 bg-gray-200 py-1">Žymė 1</p>
                                </div>
                                <div class="pl-2">
                                    <p tabindex="0" class="focus:outline-none text-xs text-gray-600 px-2 bg-gray-200 py-1">Žymė 2</p>
                                </div>
                            </div>
