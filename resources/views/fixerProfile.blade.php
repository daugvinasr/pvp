...
@section('content')
    ...
    <main class="profile-page">
        <section class="relative block h-600-px">
            <div class="absolute top-2 w-full h-full bg-center bg-cover rounded-2xl" style="background-image: url('https://images.unsplash.com/photo-1562408590-e32931084e23?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80');">
                            ...
                            <div class="w-full lg:w-4/12 px-4 lg:order-1">
                                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                                    <div class="mr-4 p-3 text-center">
                                        <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">{{$ordercount}}</span><span class="text-sm text-blueGray-400">Užsakymai</span>
                                    </div>
                                    <div class="mr-4 p-3 text-center">
                                        <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">10</span><span class="text-sm text-blueGray-400">Atsiliepimai</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-10 py-10 border-t border-blueGray-200 text-center">
                            <div class="flex flex-wrap justify-center">
                                <div class="w-full lg:w-9/12 px-4">
                                    ...
                                    <a href="/addOrder/{{$fixerData[0] -> repairmans_id}}" class="bg-indigo-600 px-6 py-2 rounded text-white hover:bg-indigo-500">Pasirinkti</a>
                                        @endif
                                </div>
                            </div>
                        </div>
